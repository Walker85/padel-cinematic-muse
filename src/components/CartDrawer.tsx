...
export const CartDrawer = ({ isDarkMode = false }: CartDrawerProps) => {
  ...
  const badgeClass = isDarkMode ? 'bg-primary text-primary-foreground' : 'bg-foreground text-background';
            ...
            <>
              <div className="flex-1 overflow-y-auto pr-2 min-h-0">
                <div className="space-y-4">
                  {items.map((item) => (
                    <div key={item.variantId} className="flex gap-4 p-2 border border-border rounded">
              ...
              <div className="flex-shrink-0 space-y-4 pt-6 border-t bg-background mt-4">
